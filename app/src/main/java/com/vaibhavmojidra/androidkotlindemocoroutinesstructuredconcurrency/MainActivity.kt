package com.vaibhavmojidra.androidkotlindemocoroutinesstructuredconcurrency
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnDownloadUserData.setOnClickListener {
            CoroutineScope(Dispatchers.Main).launch {
                //Below one is wrong way : unstructured concurrency
                //tvUserMessage.text = UserDataManager().getTotalUserCount().toString()

                //Below one is right way : structured concurrency
